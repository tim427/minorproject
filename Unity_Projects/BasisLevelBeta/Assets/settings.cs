...
public class settings : MonoBehaviour {
	...
	private void videoOptions() {		
		...
		//Function that determines what the current Vsync count is, and adjusts appropriately
		...
		//Function that checks whether anisotropic filtering is disabled, and offers the correct button
		...
		//Function that checks what the current resolution is, and allows increasing/decreasing
		//based on the current resolution (cant go lower/higher than certain resolutions) and fullscreen/windowed
		...
		//Button that allows switching between windowed and fullscreen mode
		...
		//Function that allows MSAA to be differentiated through the values 0x, 2x, 4x and 8x
		for (int i = 0; i < 4; i++) {
