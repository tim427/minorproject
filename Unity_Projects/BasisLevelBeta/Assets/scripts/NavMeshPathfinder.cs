...
public class NavMeshPathfinder : MonoBehaviour
{
		...
		void Update ()
		{
				...
				if (state != 3 && CameraController.x != 0) {
						state = 5;
				...
				case 5: 
						Vector3 cameraLastSeenPos = new Vector3 (CameraController.x, transform.position.y, CameraController.z);
			
						MoveTo (cameraLastSeenPos);
